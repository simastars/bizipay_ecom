                        ...
                        <?php else: ?>
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <form action="payment/wallet/init.php" method="post" id="wallet_form">
                                        <input type="hidden" name="amount" value="<?php echo $final_total; ?>">
                                        <div class="col-md-12 form-group">
                                            <label>Wallet Balance will be deducted</label>
                                        </div>
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn btn-primary" value="Pay with Wallet">
                                        </div>
                                    </form>
